...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val deck: IDeck = //TODO: provide an instance of an IDeck here! EX: PerfectSquaresDeck(5)
            TFCListDeck(listAll)
    ...
    fun FlashcardButtons() {
        ...
        Row (modifier = Modifier.padding(10.dp))
        {
            ...
            if(topCard.getState() == DeckState.EXHAUSTED) {
                ...
                Button(
                    onClick = { topCard = deck
                              attempts=0},   // When the button is clicked, reset to the original deck
                ...
                {
                    Text(text = "Next   ")     // This is the button for "Correct"
                }
            }
        }
    }
